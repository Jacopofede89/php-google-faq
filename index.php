...
<body>
    ...
    $questionArreys = [
        ...
        'Come state implementando la recente decisione della Corte di giustizia oblio?' => [
    ...
    foreach ($questionArreys as $question => $SubPosts) {
        echo '<h1>' . $question . '<h1/>';
        foreach ($SubPosts as $questionArreys) {
            echo '<p>' . $questionArreys . '<p/>';
        }
    }
    ?>
</body>
